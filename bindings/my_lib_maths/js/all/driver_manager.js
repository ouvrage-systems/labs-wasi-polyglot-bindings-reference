...
export function getMathsImplementation(toolchain) {
  ...
  switch (target.loader) {
    case 'native':
      ...
      break;
    case 'v0-legacy':
      driver = new WasmDriver(name, target.code, new V0LegacyLoader(hostAdapter));
      break;
    case 'v0-tiny':
    ...
    case 'v0.1-legacy':
      ...
      break;
    case 'v0.2-tiny':
      driver = new WasiV02Driver(name, target.code, new V02TinyLoader(target.binary, target.scheduler, hostAdapter));
      break;
    case 'v0.2-stdgo':
      driver = new WasiV02Driver(name, target.code, new V02TinyLoader(target.binary, target.scheduler, hostAdapter));
      break;
