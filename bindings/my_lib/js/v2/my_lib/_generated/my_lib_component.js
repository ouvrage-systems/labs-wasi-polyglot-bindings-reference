"use components";
import { fetchUrl } from '../host-http.js';
...
_trampoline1.fnName = 'wasi:clocks/monotonic-clock@0.2.0#now';
...
_trampoline7.fnName = 'wasi:cli/exit@0.2.0#exit';
...
_trampoline8.fnName = 'wasi:cli/stdin@0.2.0#getStdin';
...
_trampoline9.fnName = 'wasi:cli/stdout@0.2.0#getStdout';
let exports2;
let memory0;
let realloc0;
let realloc0Async;
...
const _trampoline10 = function(arg0, arg1, arg2) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/host-http", function="fetch-url"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_debugLog('[iface="ouvrage:lab-wasi-demo/host-http", function="fetch-url"][Instruction::Return]', {
  funcName: 'fetch-url',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline10.fnName = 'ouvrage:lab-wasi-demo/host-http#fetchUrl';
...
_trampoline11.fnName = 'wasi:filesystem/preopens@0.2.0#getDirectories';
...
_trampoline12.fnName = 'wasi:clocks/wall-clock@0.2.0#now$1';
...
_trampoline13.fnName = 'wasi:filesystem/types@0.2.0#writeViaStream';
...
_trampoline14.fnName = 'wasi:filesystem/types@0.2.0#appendViaStream';
...
_trampoline15.fnName = 'wasi:filesystem/types@0.2.0#getType';
...
_trampoline16.fnName = 'wasi:filesystem/types@0.2.0#stat';
...
_trampoline17.fnName = 'wasi:filesystem/types@0.2.0#filesystemErrorCode';
...
_trampoline18.fnName = 'wasi:io/streams@0.2.0#checkWrite';
...
_trampoline19.fnName = 'wasi:io/streams@0.2.0#write';
...
_trampoline20.fnName = 'wasi:io/streams@0.2.0#blockingWriteAndFlush';
...
_trampoline21.fnName = 'wasi:io/streams@0.2.0#blockingFlush';
...
_trampoline22.fnName = 'wasi:random/random@0.2.0#getRandomBytes';
...
_trampoline23.fnName = 'wasi:cli/environment@0.2.0#getArguments';
let exports3;
let postReturn0;
...
function distance(arg0, arg1) {
  var {x: v0_0, y: v0_1 } = arg0;
  var {x: v1_0, y: v1_1 } = arg1;
  _debugLog('[iface="ouvrage:lab-wasi-demo/geometry", function="distance"][Instruction::CallWasm] enter', {
    funcName: 'distance',
    paramCount: 4,
    async: false,
    postReturn: false,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => geometryDistance(+v0_0, +v0_1, +v1_0, +v1_1),
    });
  } catch (err) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/geometry", function="distance"][Instruction::Return]', {
    funcName: 'distance',
    paramCount: 1,
    async: false,
    postReturn: false
...
let geometryAreaRectangle;

function areaRectangle(arg0) {
  var {min: v0_0, max: v0_1 } = arg0;
  var {x: v1_0, y: v1_1 } = v0_0;
  var {x: v2_0, y: v2_1 } = v0_1;
  _debugLog('[iface="ouvrage:lab-wasi-demo/geometry", function="area-rectangle"][Instruction::CallWasm] enter', {
    funcName: 'area-rectangle',
    paramCount: 4,
    async: false,
    postReturn: false,
  });
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => geometryAreaRectangle(+v1_0, +v1_1, +v2_0, +v2_1),
    });
  } catch (err) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/geometry", function="area-rectangle"][Instruction::Return]', {
    funcName: 'area-rectangle',
    paramCount: 1,
    async: false,
    postReturn: false
...
let geometryAreaCircle;

function areaCircle(arg0) {
  var {center: v0_0, radius: v0_1 } = arg0;
  var {x: v1_0, y: v1_1 } = v0_0;
  _debugLog('[iface="ouvrage:lab-wasi-demo/geometry", function="area-circle"][Instruction::CallWasm] enter', {
    funcName: 'area-circle',
    paramCount: 3,
    async: false,
    postReturn: false,
  });
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => geometryAreaCircle(+v1_0, +v1_1, +v0_1),
    });
  } catch (err) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/geometry", function="area-circle"][Instruction::Return]', {
    funcName: 'area-circle',
    paramCount: 1,
    async: false,
    postReturn: false
...
let geometryAreaTriangle;

function areaTriangle(arg0) {
  var {a: v0_0, b: v0_1, c: v0_2 } = arg0;
  var {x: v1_0, y: v1_1 } = v0_0;
  var {x: v2_0, y: v2_1 } = v0_1;
  var {x: v3_0, y: v3_1 } = v0_2;
  _debugLog('[iface="ouvrage:lab-wasi-demo/geometry", function="area-triangle"][Instruction::CallWasm] enter', {
    funcName: 'area-triangle',
    paramCount: 6,
    async: false,
    postReturn: false,
  });
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => geometryAreaTriangle(+v1_0, +v1_1, +v2_0, +v2_1, +v3_0, +v3_1),
    });
  } catch (err) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/geometry", function="area-triangle"][Instruction::Return]', {
    funcName: 'area-triangle',
    paramCount: 1,
    async: false,
    postReturn: false
...
let storeConstructorKvStore;

class KvStore{
  constructor() {
    _debugLog('[iface="ouvrage:lab-wasi-demo/store", function="[constructor]kv-store"][Instruction::CallWasm] enter', {
...
let storeMethodKvStoreSet;

KvStore.prototype.set = function set(arg1, arg2) {
  
  var handle1 = this[symbolRscHandle];
  if (!handle1 || (handleTable4[(handle1 << 1) + 1] & T_FLAG) === 0) {
    throw new TypeError('Resource error: Not a valid \"KvStore\" resource.');
  }
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/store", function="[method]kv-store.set"][Instruction::CallWasm] enter', {
    funcName: '[method]kv-store.set',
    paramCount: 5,
    async: false,
    postReturn: false,
  });
  ...
  try {
    _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => storeMethodKvStoreSet(handle0, ptr2, len2, ptr3, len3),
    });
  } catch (err) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/store", function="[method]kv-store.set"][Instruction::Return]', {
    funcName: '[method]kv-store.set',
    paramCount: 0,
    async: false,
    postReturn: false
...
let storeMethodKvStoreGet;

KvStore.prototype.get = function get(arg1) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/store", function="[method]kv-store.get"][Instruction::CallWasm] enter', {
    funcName: '[method]kv-store.get',
    paramCount: 3,
    async: false,
    postReturn: true,
  });
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => storeMethodKvStoreGet(handle0, ptr2, len2),
    });
  } catch (err) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/store", function="[method]kv-store.get"][Instruction::Return]', {
    funcName: '[method]kv-store.get',
    paramCount: 1,
    async: false,
    postReturn: true
...
let storeMethodKvStoreDelete;

KvStore.prototype.delete = function $delete(arg1) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/store", function="[method]kv-store.delete"][Instruction::CallWasm] enter', {
    funcName: '[method]kv-store.delete',
    paramCount: 3,
    async: false,
    postReturn: false,
  });
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => storeMethodKvStoreDelete(handle0, ptr2, len2),
    });
  } catch (err) {
  ...
  var bool3 = ret;
  _debugLog('[iface="ouvrage:lab-wasi-demo/store", function="[method]kv-store.delete"][Instruction::Return]', {
    funcName: '[method]kv-store.delete',
    paramCount: 1,
    async: false,
    postReturn: false
...
function formatMessage(arg0) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/lang", function="format-message"][Instruction::CallWasm] enter', {
    funcName: 'format-message',
    paramCount: 2,
    async: false,
    postReturn: true,
  });
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => langFormatMessage(ptr0, len0),
    });
  } catch (err) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/lang", function="format-message"][Instruction::Return]', {
    funcName: 'format-message',
    paramCount: 1,
    async: false,
    postReturn: true
...
let langReverseString;

function reverseString(arg0) {
  
  var encodeRes = _utf8AllocateAndEncode(arg0, realloc0, memory0);
  var ptr0= encodeRes.ptr;
  var len0 = encodeRes.len;
  
  _debugLog('[iface="ouvrage:lab-wasi-demo/lang", function="reverse-string"][Instruction::CallWasm] enter', {
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => langReverseString(ptr0, len0),
    });
  } catch (err) {
  ...
  var len1 = dataView(memory0).getUint32(ret + 4, true);
  var result1 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr1, len1));
  _debugLog('[iface="ouvrage:lab-wasi-demo/lang", function="reverse-string"][Instruction::Return]', {
    funcName: 'reverse-string',
    paramCount: 1,
    async: false,
    postReturn: true
...
let networkFetchAndFormat;

function fetchAndFormat(arg0) {
  
  var encodeRes = _utf8AllocateAndEncode(arg0, realloc0, memory0);
  var ptr0= encodeRes.ptr;
  var len0 = encodeRes.len;
  
  _debugLog('[iface="ouvrage:lab-wasi-demo/network", function="fetch-and-format"][Instruction::CallWasm] enter', {
    funcName: 'fetch-and-format',
    paramCount: 2,
    async: false,
    postReturn: true,
  });
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => networkFetchAndFormat(ptr0, len0),
    });
  } catch (err) {
  ...
  _debugLog('[iface="ouvrage:lab-wasi-demo/network", function="fetch-and-format"][Instruction::Return]', {
    funcName: 'fetch-and-format',
    paramCount: 1,
    async: false,
    postReturn: true
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./my_lib_component.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./my_lib_component.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module2));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      '[export]ouvrage:lab-wasi-demo/store': {
        '[resource-new]kv-store': trampoline0,
      },
      'ouvrage:lab-wasi-demo/host-http': {
        'fetch-url': exports0['0'],
      },
      wasi_snapshot_preview1: {
        args_get: exports0['18'],
        args_sizes_get: exports0['17'],
        clock_time_get: exports0['16'],
    ...
    ({ exports: exports3 } = yield instantiateCore(yield module3, {
      '': {
        ...
        '16': exports2.clock_time_get,
        '17': exports2.args_sizes_get,
        '18': exports2.args_get,
    ...
    postReturn0 = exports1['cabi_post_ouvrage:lab-wasi-demo/store#[method]kv-store.get'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_ouvrage:lab-wasi-demo/store#[method]kv-store.get']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_ouvrage:lab-wasi-demo/store#[method]kv-store.get'];
    }
    
    postReturn1 = exports1['cabi_post_ouvrage:lab-wasi-demo/lang#format-message'];
    
    try {
      postReturn1Async = WebAssembly.promising(exports1['cabi_post_ouvrage:lab-wasi-demo/lang#format-message']);
    } catch(err) {
      postReturn1Async = exports1['cabi_post_ouvrage:lab-wasi-demo/lang#format-message'];
    }
    
    postReturn2 = exports1['cabi_post_ouvrage:lab-wasi-demo/lang#reverse-string'];
    
    try {
      postReturn2Async = WebAssembly.promising(exports1['cabi_post_ouvrage:lab-wasi-demo/lang#reverse-string']);
    } catch(err) {
      postReturn2Async = exports1['cabi_post_ouvrage:lab-wasi-demo/lang#reverse-string'];
    }
    
    postReturn3 = exports1['cabi_post_ouvrage:lab-wasi-demo/network#fetch-and-format'];
    
    try {
      postReturn3Async = WebAssembly.promising(exports1['cabi_post_ouvrage:lab-wasi-demo/network#fetch-and-format']);
    } catch(err) {
      postReturn3Async = exports1['cabi_post_ouvrage:lab-wasi-demo/network#fetch-and-format'];
    }
    
    geometryDistance = exports1['ouvrage:lab-wasi-demo/geometry#distance'];
    geometryAreaRectangle = exports1['ouvrage:lab-wasi-demo/geometry#area-rectangle'];
    geometryAreaCircle = exports1['ouvrage:lab-wasi-demo/geometry#area-circle'];
    geometryAreaTriangle = exports1['ouvrage:lab-wasi-demo/geometry#area-triangle'];
    storeConstructorKvStore = exports1['ouvrage:lab-wasi-demo/store#[constructor]kv-store'];
    storeMethodKvStoreSet = exports1['ouvrage:lab-wasi-demo/store#[method]kv-store.set'];
    storeMethodKvStoreGet = exports1['ouvrage:lab-wasi-demo/store#[method]kv-store.get'];
    storeMethodKvStoreDelete = exports1['ouvrage:lab-wasi-demo/store#[method]kv-store.delete'];
    langFormatMessage = exports1['ouvrage:lab-wasi-demo/lang#format-message'];
    langReverseString = exports1['ouvrage:lab-wasi-demo/lang#reverse-string'];
    networkFetchAndFormat = exports1['ouvrage:lab-wasi-demo/network#fetch-and-format'];
  })();
