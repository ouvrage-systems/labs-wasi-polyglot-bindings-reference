...
function getExports(binaryName = 'my_lib.wasm') {
...
export async function call(funcName, ...args) {
  return callWithBinary('my_lib.wasm', funcName, ...args);
}

export async function callCold(funcName, ...args) {
  return callColdWithBinary('my_lib.wasm', funcName, ...args);
}

export async function getWasmByteSize(binaryName = 'my_lib.wasm') {
