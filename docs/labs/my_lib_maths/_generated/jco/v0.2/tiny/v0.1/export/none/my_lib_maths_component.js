"use components";
import { exit as exit$1, stderr, stdin, stdout } from 'https://esm.sh/@bytecodealliance/preview2-shim@0.19.0/cli';
import { preopens, types } from 'https://esm.sh/@bytecodealliance/preview2-shim@0.19.0/filesystem';
import { error, streams } from 'https://esm.sh/@bytecodealliance/preview2-shim@0.19.0/io';
...
_trampoline4.fnName = 'wasi:cli/stderr@0.2.0#getStderr';
...
_trampoline5.fnName = 'wasi:cli/exit@0.2.0#exit';
...
_trampoline7.fnName = 'wasi:cli/stdout@0.2.0#getStdout';
let exports2;
let memory0;
let realloc0;
let realloc0Async;
...
_trampoline9.fnName = 'wasi:filesystem/types@0.2.0#writeViaStream';
...
_trampoline10.fnName = 'wasi:filesystem/types@0.2.0#appendViaStream';
...
_trampoline11.fnName = 'wasi:filesystem/types@0.2.0#getType';
...
_trampoline12.fnName = 'wasi:filesystem/types@0.2.0#stat';
...
_trampoline13.fnName = 'wasi:filesystem/types@0.2.0#filesystemErrorCode';
...
_trampoline14.fnName = 'wasi:io/streams@0.2.0#checkWrite';
...
_trampoline15.fnName = 'wasi:io/streams@0.2.0#write';
...
_trampoline16.fnName = 'wasi:io/streams@0.2.0#blockingWriteAndFlush';
...
_trampoline17.fnName = 'wasi:io/streams@0.2.0#blockingFlush';
...
_trampoline18.fnName = 'wasi:random/random@0.2.0#getRandomBytes';
let exports3;
let exports1Add;
...
export const $init = (() => {
  let gen = (function* _initGenerator () {
    ...
    const module2 = base64Compile('');
    const module3 = base64Compile('');
