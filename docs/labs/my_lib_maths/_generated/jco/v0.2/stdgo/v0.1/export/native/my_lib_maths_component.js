"use components";
import { environment, exit as exit$1, stderr, stdin, stdout } from 'https://esm.sh/@bytecodealliance/preview2-shim@0.19.0/cli';
import { monotonicClock, wallClock } from 'https://esm.sh/@bytecodealliance/preview2-shim@0.19.0/clocks';
import { preopens, types } from 'https://esm.sh/@bytecodealliance/preview2-shim@0.19.0/filesystem';
import { error, poll as poll$1, streams } from 'https://esm.sh/@bytecodealliance/preview2-shim@0.19.0/io';
import { random } from 'https://esm.sh/@bytecodealliance/preview2-shim@0.19.0/random';
const { getArguments,
...
async function fetchCompile (url) {
  ...
  return fetch(url).then(res => res.arrayBuffer()).then(WebAssembly.compile);
}
...
_trampoline0.fnName = 'wasi:clocks/monotonic-clock@0.2.0#now';
...
_trampoline5.fnName = 'wasi:clocks/monotonic-clock@0.2.0#subscribeDuration';
...
_trampoline6.fnName = 'wasi:clocks/monotonic-clock@0.2.0#subscribeInstant';
...
_trampoline7.fnName = 'wasi:io/streams@0.2.0#subscribe';
...
_trampoline8.fnName = 'wasi:io/streams@0.2.0#subscribe';
...
_trampoline10.fnName = 'wasi:cli/stderr@0.2.0#getStderr';
...
_trampoline11.fnName = 'wasi:cli/exit@0.2.0#exit';
...
_trampoline12.fnName = 'wasi:cli/stdin@0.2.0#getStdin';
...
_trampoline13.fnName = 'wasi:cli/stdout@0.2.0#getStdout';
let exports2;
let memory0;
let realloc0;
let realloc0Async;
...
_trampoline14.fnName = 'wasi:filesystem/preopens@0.2.0#getDirectories';
...
_trampoline15.fnName = 'wasi:clocks/wall-clock@0.2.0#now$1';
...
_trampoline16.fnName = 'wasi:filesystem/types@0.2.0#readViaStream';
...
_trampoline17.fnName = 'wasi:filesystem/types@0.2.0#writeViaStream';
...
_trampoline18.fnName = 'wasi:filesystem/types@0.2.0#appendViaStream';
...
_trampoline19.fnName = 'wasi:filesystem/types@0.2.0#getType';
...
_trampoline20.fnName = 'wasi:filesystem/types@0.2.0#stat';
...
_trampoline21.fnName = 'wasi:filesystem/types@0.2.0#filesystemErrorCode';
...
_trampoline22.fnName = 'wasi:io/streams@0.2.0#checkWrite';
...
_trampoline23.fnName = 'wasi:io/streams@0.2.0#write';

const _trampoline24 = function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
...
_trampoline24.fnName = 'wasi:io/streams@0.2.0#blockingWriteAndFlush';
...
_trampoline25.fnName = 'wasi:io/streams@0.2.0#blockingFlush';
...
_trampoline26.fnName = 'wasi:io/poll@0.2.0#poll';
...
_trampoline27.fnName = 'wasi:random/random@0.2.0#getRandomBytes';
...
_trampoline28.fnName = 'wasi:cli/environment@0.2.0#getEnvironment';
...
_trampoline29.fnName = 'wasi:cli/environment@0.2.0#getArguments';
let exports3;
let exports1Add;

function add(arg0, arg1) {
  if (!_initialized) throwUninitialized();
  _debugLog('[iface="add", function="add"][Instruction::CallWasm] enter', {
    funcName: 'add',
    paramCount: 2,
    async: false,
    postReturn: false,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1Add(toInt64(arg0), toInt64(arg1)),
    });
  } catch (err) {
...
let exports1ComputeSequence;

function computeSequence(arg0, arg1, arg2) {
  if (!_initialized) throwUninitialized();
  _debugLog('[iface="compute-sequence", function="compute-sequence"][Instruction::CallWasm] enter', {
    funcName: 'compute-sequence',
    paramCount: 3,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isManualAsync: false,
    preserveFutureResult: false,
    entryFnName: 'exports1ComputeSequence',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1ComputeSequence(toInt64(arg0), toInt64(arg1), toInt64(arg2)),
    });
  } catch (err) {
  ...
  _debugLog('[iface="compute-sequence", function="compute-sequence"][Instruction::Return]', {
    funcName: 'compute-sequence',
    paramCount: 1,
    async: false,
    postReturn: false
...
function isPrime(arg0) {
  if (!_initialized) throwUninitialized();
  _debugLog('[iface="is-prime", function="is-prime"][Instruction::CallWasm] enter', {
    funcName: 'is-prime',
    paramCount: 1,
    async: false,
    postReturn: false,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1IsPrime(toInt64(arg0)),
    });
  } catch (err) {
  ...
  var bool0 = ret;
  _debugLog('[iface="is-prime", function="is-prime"][Instruction::Return]', {
    funcName: 'is-prime',
    paramCount: 1,
    async: false,
    postReturn: false
...
let exports1CountPrimes;

function countPrimes(arg0, arg1) {
  if (!_initialized) throwUninitialized();
  _debugLog('[iface="count-primes", function="count-primes"][Instruction::CallWasm] enter', {
    funcName: 'count-primes',
    paramCount: 2,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isManualAsync: false,
    preserveFutureResult: false,
    entryFnName: 'exports1CountPrimes',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1CountPrimes(toInt64(arg0), toInt64(arg1)),
    });
  } catch (err) {
  ...
  _debugLog('[iface="count-primes", function="count-primes"][Instruction::Return]', {
    funcName: 'count-primes',
    paramCount: 1,
    async: false,
    postReturn: false
...
let exports1FindLastPrime;

function findLastPrime(arg0) {
  if (!_initialized) throwUninitialized();
  _debugLog('[iface="find-last-prime", function="find-last-prime"][Instruction::CallWasm] enter', {
    funcName: 'find-last-prime',
    paramCount: 1,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isManualAsync: false,
    preserveFutureResult: false,
    entryFnName: 'exports1FindLastPrime',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1FindLastPrime(toInt64(arg0)),
    });
  } catch (err) {
  ...
  _debugLog('[iface="find-last-prime", function="find-last-prime"][Instruction::Return]', {
    funcName: 'find-last-prime',
    paramCount: 1,
    async: false,
    postReturn: false
...
let exports1ConcurrentCountPrimes;

function concurrentCountPrimes(arg0, arg1) {
  if (!_initialized) throwUninitialized();
  _debugLog('[iface="concurrent-count-primes", function="concurrent-count-primes"][Instruction::CallWasm] enter', {
    funcName: 'concurrent-count-primes',
    paramCount: 2,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isManualAsync: false,
    preserveFutureResult: false,
    entryFnName: 'exports1ConcurrentCountPrimes',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1ConcurrentCountPrimes(toInt64(arg0), toInt32(arg1)),
    });
  } catch (err) {
  ...
  _debugLog('[iface="concurrent-count-primes", function="concurrent-count-primes"][Instruction::Return]', {
    funcName: 'concurrent-count-primes',
    paramCount: 1,
    async: false,
    postReturn: false
...
let exports1Fibonacci;

function fibonacci(arg0) {
  if (!_initialized) throwUninitialized();
  _debugLog('[iface="fibonacci", function="fibonacci"][Instruction::CallWasm] enter', {
    funcName: 'fibonacci',
    paramCount: 1,
    async: false,
    postReturn: false,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1Fibonacci(toInt64(arg0)),
    });
  } catch (err) {
  ...
  _debugLog('[iface="fibonacci", function="fibonacci"][Instruction::Return]', {
    funcName: 'fibonacci',
    paramCount: 1,
    async: false,
    postReturn: false
...
let exports1FibonacciRecursive;

function fibonacciRecursive(arg0) {
  if (!_initialized) throwUninitialized();
  _debugLog('[iface="fibonacci-recursive", function="fibonacci-recursive"][Instruction::CallWasm] enter', {
    funcName: 'fibonacci-recursive',
    paramCount: 1,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isManualAsync: false,
    preserveFutureResult: false,
    entryFnName: 'exports1FibonacciRecursive',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1FibonacciRecursive(toInt64(arg0)),
    });
  } catch (err) {
  ...
  _debugLog('[iface="fibonacci-recursive", function="fibonacci-recursive"][Instruction::Return]', {
    funcName: 'fibonacci-recursive',
    paramCount: 1,
    async: false,
    postReturn: false
...
export const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./my_lib_maths_component.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./my_lib_maths_component.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module2));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      wasi_snapshot_preview1: {
        args_get: (argvPtr, argvBufPtr) => 0,
        args_sizes_get: (argcPtr, argvBufSizePtr) => { const view = new DataView(exports1.memory.buffer); view.setUint32(argcPtr, 0, true); view.setUint32(argvBufSizePtr, 0, true); return 0; },
        clock_time_get: exports0['20'],
        environ_get: (environPtr, environBufPtr) => 0,
        environ_sizes_get: (envCountPtr, envBufSizePtr) => { const view = new DataView(exports1.memory.buffer); view.setUint32(envCountPtr, 0, true); view.setUint32(envBufSizePtr, 0, true); return 0; },
        fd_write: exports0['23'],
        poll_oneoff: exports0['25'],
        proc_exit: exports0['17'],
        random_get: exports0['24'],
        sched_yield: exports0['16'],
      },
    }));
    ...
    ({ exports: exports3 } = yield instantiateCore(yield module3, {
      '': {
        ...
        '14': trampoline28,
        '15': trampoline29,
        '16': exports2.sched_yield,
        '17': exports2.proc_exit,
        '18': exports2.args_get,
        '19': exports2.args_sizes_get,
        '2': trampoline16,
    ...
    exports1ComputeSequence = exports1['compute-sequence'];
    exports1IsPrime = exports1['is-prime'];
    exports1CountPrimes = exports1['count-primes'];
    exports1FindLastPrime = exports1['find-last-prime'];
    exports1ConcurrentCountPrimes = exports1['concurrent-count-primes'];
    exports1Fibonacci = exports1.fibonacci;
    exports1FibonacciRecursive = exports1['fibonacci-recursive']; if (exports1._initialize) exports1._initialize(); else if (exports1._start) exports1._start();
  })();
...
export { add, computeSequence, concurrentCountPrimes, countPrimes, fibonacci, fibonacciRecursive, findLastPrime, isPrime,  }
export const _util = {
